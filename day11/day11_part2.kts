...
/*
 * Part 2 of day 11: https://adventofcode.com/2023/day/11
 */
...
val emptinessMultiplier = 1000000
...
for (i in 0 until galaxyPositions.size) {
	...
	for (j in i + 1 until galaxyPositions.size) {
		...
		val emptyDistance = ((numOfEmptyRowsBetweenThem * emptinessMultiplier) + numOfEmptyColumnsBetweenThem * emptinessMultiplier) - (numOfEmptyRowsBetweenThem + numOfEmptyColumnsBetweenThem)

		shortestPathsSum += distance + emptyDistance
	}
}
